...
std::vector<SceneNode*> CameraManager::m_cameraSwitch;
int CameraManager::m_cameraIndex;
...
CameraManager::CameraManager(PE::GameContext &context, PE::MemoryArena arena, Handle hMyself) : Component(context, arena, hMyself)
{
	...
	pCamSN->m_base.setPos(Vector3(10.0f,40.0f,-25.0f));
	pCamSN->m_base.turnInDirection(Vector3(-30.0f, 0.0f, -1.1f) - Vector3(10.0f,40.0f,-25.0f));

	m_cameraSwitch.push_back(pCamSN);  // default sky camera
	m_cameraIndex = 0;
}
