...
struct DebugRenderer : public SceneNode
{
	...
	void createBoundingBoxLineMesh(bool hasTransform, const Matrix4x4 &transform, float *pRawData, int numInRawData, float timeToLive, float scale = 1.0f);
	...
	const static bool drawBoundingBox = false;
	// whether to draw bounding volume
