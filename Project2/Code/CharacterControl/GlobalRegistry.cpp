	...
	// start root
	{
		...
		// start root.CharacterControl
		{
			...
			// start root.CharacterControl.Components
			{
				...
				CarController1::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				CarGameControls1::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
			...
			// start root.CharacterControl.Events
			{
				...
				/*
				Event_Car1_Throttle::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				Event_Car1_Turn::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				*/
			}
