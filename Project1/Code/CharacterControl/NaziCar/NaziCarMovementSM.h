...
struct NaziCarMovementSM : public PE::Components::Component
{
	...
	//
	PE_DECLARE_IMPLEMENT_EVENT_HANDLER_WRAPPER(do_NaziCarMovementSM_Event_MOVE_TO)
	virtual void do_NaziCarMovementSM_Event_MOVE_TO(PE::Events::Event *pEvt);
	//
	PE_DECLARE_IMPLEMENT_EVENT_HANDLER_WRAPPER(do_NaziCarMovementSM_Event_STOP)
	virtual void do_NaziCarMovementSM_Event_STOP(PE::Events::Event *pEvt);
	//
