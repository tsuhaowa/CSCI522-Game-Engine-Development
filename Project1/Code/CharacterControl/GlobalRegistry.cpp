...
#include "NaziCar/NaziCar.h"
#include "NaziCar/NaziCarMovementSM.h"
#include "NaziCar/NaziCarBehaviorSM.h"
#include "WayPoint.h"
	...
	// start root
	{
		...
		// start root.CharacterControl
		{
			...
			// start root.CharacterControl.Components
			{
				...
				NaziCar::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				NaziCarMovementSM::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				NaziCarBehaviorSM::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
			...
			// start root.CharacterControl.Events
			{
				...
				Event_CREATE_NAZICAR::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				NaziCarMovementSM_Event_MOVE_TO::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				NaziCarMovementSM_Event_TARGET_REACHED::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				NaziCarMovementSM_Event_STOP::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
