...
const char *toString(EPEVertexFormatLayout v)
{
	...
	case PEVertexFormatLayout_DetailedMesh_B0__P0f3_TC0f2_TC7f2_N0f3_T0f3: return "PEVertexFormatLayout_DetailedMesh_B0__P0f3_TC0f2_TC7f2_N0f3_T0f3";
	case PEVertexFormatLayout_DetailedMesh_B0__P0f3_B1__TC0f_B2__N0f3_B3__T0f3: return "PEVertexFormatLayout_DetailedMesh_B0__P0f3_B1__TC0f_B2__N0f3_B3__T0f3";
...
void PEVertexAttributeInfo::elementSemanticToApiSemantic(PESemanticType sem, int semOrder, int &out_sem, int &out_semOrder)
{
	...
	case PESemanticType_TexCoord:
		...
		else if (semOrder == 7) { out_sem = API_CHOOSE_DX11_DX9(0 /*dx11 tracks semantics by strings*/, D3DDECLUSAGE_TEXCOORD); out_semOrder = 7; return; }
		else{assert(!"This semantic order for this type is not supported. Make sure value is correct and add support if needed.");return;}
	case PESemanticType_Color:
