...
void VertexBufferGPUManager::setupVertexBufferInfos()
{
	...
	{
		PEVertexBufferInfo info(*m_pContext, m_arena, PEVertexFormatLayout_DetailedMesh_B0__P0f3_TC0f2_TC7f2_N0f3_T0f3);
		info.m_bufferInfos.reset(1);
		PEVertexAttributeBufferInfo buf0;
		// position
		...
		buf0.m_attributeInfos[buf0.m_numAttributes++] = PEVertexAttributeInfo(3 * 4, PEScalarType_Float, 2, PESemanticType_TexCoord, "texcoord", 0);
		buf0.m_attributeInfos[buf0.m_numAttributes++] = PEVertexAttributeInfo(5 * 4, PEScalarType_Float, 2, PESemanticType_TexCoord, "texcoord", 7);
		buf0.m_attributeInfos[buf0.m_numAttributes++] = PEVertexAttributeInfo(7 * 4, PEScalarType_Float, 3, PESemanticType_Normal, "normal", 0);
		buf0.m_attributeInfos[buf0.m_numAttributes++] = PEVertexAttributeInfo(10 * 4, PEScalarType_Float, 3, PESemanticType_Tangent, "tangent", 0);
	...
	{
		PEVertexBufferInfo info(*m_pContext, m_arena, PEVertexFormatLayout_DetailedMesh_B0__P0f3_B1__TC0f_B2__N0f3_B3__T0f3);
