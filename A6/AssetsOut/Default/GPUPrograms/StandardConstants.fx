...
BEGIN_BUFFER  // total registers: 3 absoulte: [163-165]
// only use xz = wind source xz
API_UNIFORM_CONSTANT float4 gWind0				API_UNIFORM_CONSTANT_REGISTER_REG(0, 163);
API_UNIFORM_CONSTANT float4 gWind1              API_UNIFORM_CONSTANT_REGISTER_REG(1, 164);
API_UNIFORM_CONSTANT float4 gWind2              API_UNIFORM_CONSTANT_REGISTER_REG(2, 165);
END_BUFFER
